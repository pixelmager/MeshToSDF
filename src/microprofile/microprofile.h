...
#define MICROPROFILE_GPU_TIMERS (MICROPROFILE_GPU_TIMERS_GL || MICROPROFILE_GPU_TIMERS_D3D11 || MICROPROFILE_GPU_TIMERS_D3D12 || MICROPROFILE_GPU_TIMERS_VULKAN)
#endif
...
#define MICROPROFILE_MAX_THREADS 512
#endif 
